...
export const Hero =()=>{
 return (<div className="w-full bg-background-primary flex flex-col items-center ">
    <div className="flex flex-col items-center justify-center w-full h-[500px]">
        ...
        <button className="text-white bg-[#4E7AFF] font-[500] p-1 rounded-lg">Start Solving</button>
            <button className="text-Content-Secondary font-[500] p-1 rounded-lg">Explore Features {`->`}</button>
        </div>        
    </div>
